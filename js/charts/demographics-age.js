...
$(function() {
  ...
  Highcharts.chart('chart-demographics-age', Highcharts.merge(columnChartSettings, {
    title: {
      text: description
    },
    series: seriesData
  ...
  Highcharts.chart('chart-demographics-age-percentage', Highcharts.merge(pieChartSettings, {
      title: {
